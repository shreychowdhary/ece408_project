...
__global__ void forward_kernel(float *y, const float *x, const float *k, const int M, const int C, const int H, const int W, const int K, const int W_grid, const int H_out, const int W_out)
{
...
void forward<gpu, float>(mshadow::Tensor<gpu, 4, float> &y, const mshadow::Tensor<gpu, 4, float> &x, const mshadow::Tensor<gpu, 4, float> &w)
{
    ...
    // Extract the tensor dimensions into B,M,C,H,W,K
		...
		const int H_grid = ceil(H_out/(float)TILE_WIDTH); // Number of vertial tiles per output map
